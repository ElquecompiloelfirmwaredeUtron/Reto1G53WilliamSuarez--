...
public class AddUserForm extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cbTipoDocumento.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cédula de ciudadanía", "Tarjeta de identidad", "Cedula extranjería", "Passaporte" }));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        System.out.println("Nombre"+nombre+"Apellidos"+apellidos+"Documento"+documento+"Tdocumento"+tipoDocumento+"Correo"+correo);
